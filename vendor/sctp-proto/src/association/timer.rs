...
// TANGO PATCH: delayed-SACK interval lowered from 200ms (RFC default) to 20ms,
// matching libdatachannel. A 200ms SACK delay inflates the sender's RTT estimate
// and slows dup-SACK-driven fast retransmit; 20ms keeps recovery prompt for a
// 60 Hz stream.
pub(crate) const ACK_INTERVAL: u64 = 20;
