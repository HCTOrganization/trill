...
// RTO values in milliseconds. TANGO PATCH: lowered from the RFC 4960 defaults
// (3000/1000/60000), which are catastrophic for a 60 Hz real-time game — a lost
// chunk that needs the timer waits a full second-plus before recovery. These
// match libdatachannel's usrsctp tuning, which tolerated loss fine.
