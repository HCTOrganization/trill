...
settings-theme-color-speaki-brown = Speaki Braun
...
settings-netplay-endpoint-easserver = Trill (Ostasien-Server)
settings-netplay-endpoint-tango = Tango
settings-netplay-endpoint-tango-warning = Der Verwalter hat die AGPL verletzt, indem er den von diesem Server verwendeten Signalisierungsserver-Quellcode entfernt hat. Daher wird die Verwendung dieses Servers nicht mehr empfohlen.
...
settings-border-preference = Emulator-Rahmeneinstellung
settings-border-preference-bnlc = BNLC
settings-border-preference-custom = Benutzerdefiniert
settings-border-preference-locate = Suchen
settings-border-preference-disable = Keinen Rahmen anzeigen
...
settings-audio-enable-prebattle-voice = Pre-Battle-Stimme im PvP aktivieren
settings-audio-prebattle-voice-volume = Stimmlautstärke
