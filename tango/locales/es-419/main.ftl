...
settings-theme-color-trill-yellow = Amarillo Trill
settings-theme-color-pegasus-blue = Azul Pegasus
settings-theme-color-sonia-pink = Rosa Sonia
settings-theme-color-zerker-grey = Gris Zerker
settings-theme-color-ninja-green = Verde Ninja
settings-theme-color-saurian-orange = Naranja Saurian
settings-theme-color-rogue-purple = Púrpura Rogue
settings-theme-color-ace-black = Negro Ace
settings-theme-color-joker-red = Rojo Joker
settings-theme-color-speaki-brown = Marrón Speaki
...
settings-netplay-endpoint-tango-warning = El mantenedor ha violado la AGPL al eliminar el código fuente del servidor de señalización utilizado por este servidor. Por lo tanto, ya no se recomienda usar este servidor.
...
settings-border-preference = Preferencia de borde del emulador
...
settings-border-preference-disable = No mostrar borde
...
navicust-edit-tips-rightclick = Clic derecho: Eliminar pieza
navicust-edit-tips-wheel = Rueda del ratón: Rotación en sentido horario
...
settings-audio-enable-startup-voice = Activar voz de inicio
settings-audio-enable-prebattle-voice = Activar voz de pre-batalla durante PvP
settings-audio-prebattle-voice-volume = Volumen de voz
