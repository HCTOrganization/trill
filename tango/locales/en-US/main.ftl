...
settings-theme-color-trill-yellow = Trill Yellow
settings-theme-color-pegasus-blue = Pegasus Blue
settings-theme-color-sonia-pink = Sonia Pink
settings-theme-color-zerker-grey = Zerker Grey
settings-theme-color-ninja-green = Ninja Green
...
settings-netplay-endpoint-tango-warning = The maintainer has violated AGPL by removing the signaling server source code used by this server. Therefore using this server is no longer recommended.
...
settings-border-preference = Emulator Border Preference
settings-border-preference-bnlc = BNLC
settings-border-preference-custom = Custom
settings-border-preference-locate = Locate
settings-border-preference-disable = Do not display border
