...
settings-theme-color = Couleur du thème
settings-theme-color-trill-yellow = Jaune Trill
settings-theme-color-pegasus-blue = Bleu Pegasus
settings-theme-color-sonia-pink = Rose Sonia
settings-theme-color-zerker-grey = Gris Zerker
settings-theme-color-ninja-green = Vert Ninja
settings-theme-color-saurian-orange = Orange Saurian
settings-theme-color-rogue-purple = Violet Rogue
settings-theme-color-ace-black = Noir Ace
settings-theme-color-joker-red = Rouge Joker
settings-theme-color-speaki-brown = Marron Speaki
...
settings-netplay-endpoint-easserver = Trill (Serveur Asie de l'Est)
settings-netplay-endpoint-tango = Tango
settings-netplay-endpoint-tango-warning = Le mainteneur a violé l'AGPL en supprimant le code source du serveur de signalisation utilisé par ce serveur. Par conséquent, l'utilisation de ce serveur n'est plus recommandée.
...
settings-border-preference = Préférence de bordure de l'émulateur
settings-border-preference-bnlc = BNLC
settings-border-preference-custom = Personnalisé
settings-border-preference-locate = Localiser
settings-border-preference-disable = Ne pas afficher la bordure
...
navicust-edit-tips-rightclick = Clic droit : Supprimer la pièce
navicust-edit-tips-wheel = Roulette de la souris : Rotation dans le sens des aiguilles d'une montre
...
settings-audio-prebattle-voice-volume = Volume de la voix
