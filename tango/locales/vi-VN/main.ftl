...
settings-border-preference = Tùy chọn viền giả lập
settings-border-preference-bnlc = BNLC
settings-border-preference-custom = Tùy chỉnh
settings-border-preference-locate = Định vị
settings-border-preference-disable = Không hiển thị viền
...
settings-audio-prebattle-voice-volume = Âm lượng giọng nói
