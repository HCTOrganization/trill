...
settings-border-preference = Preferência de borda do emulador
settings-border-preference-bnlc = BNLC
settings-border-preference-custom = Personalizado
settings-border-preference-locate = Localizar
settings-border-preference-disable = Não exibir borda
save-tab-cover = Capa
save-tab-navi = Navi
...
navicust-edit-tips-rightclick = Clique direito: Remover peça
navicust-edit-tips-wheel = Roda do mouse: Girar no sentido horário
...
settings-audio-enable-startup-voice = Ativar voz de inicialização
settings-audio-enable-prebattle-voice = Ativar voz de pré-batalha durante o PvP
settings-audio-prebattle-voice-volume = Volume da voz
