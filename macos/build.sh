...
# Cleanup.
function cleanup {
    rm -rf Trill.iconset Trill.app trill_macos_workdir
}
trap cleanup EXIT
cleanup
...
lipo -create target/{aarch64-apple-darwin,x86_64-apple-darwin}/release-dist/tango -output Trill.app/Contents/MacOS/trill
...
lipo -create trill_macos_workdir/ffmpeg-{arm64,x64} -output Trill.app/Contents/MacOS/ffmpeg
